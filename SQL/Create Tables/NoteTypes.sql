    ...
    BEGIN TRANSACTION
        ...
        BEGIN
            ...
            (
                ...
                NoteTypeDescription     varchar(50)     NOT NULL,
            ...
            ALTER TABLE dbo.NoteTypes 
                ADD CONSTRAINT [PK_NoteTypes] PRIMARY KEY CLUSTERED (NoteTypeId ASC)
                WITH( STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]

            ---===========---
            ---== INDEX ==---
            ---===========---
            CREATE NONCLUSTERED INDEX IX_Lottery_JobNumber ON dbo.NoteTypes
                (NoteTypeId) WITH( STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
