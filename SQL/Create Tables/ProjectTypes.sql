    ...
    BEGIN TRANSACTION
        ...
        BEGIN
            ...
            (
                ...
                ProjectTypeDescription		char(100)       NOT NULL,
            ...
            ALTER TABLE dbo.ProjectTypes 
                ADD CONSTRAINT [PK_ProjectTypes] PRIMARY KEY CLUSTERED (ProjectTypeId ASC)
                WITH( STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]

            -- Defaults & Check Constraints
			ALTER TABLE dbo.ProjectTypes WITH CHECK
				ADD CONSTRAINT UC_ProjectTypes_ProjectTypeDescription UNIQUE (ProjectTypeDescription)
